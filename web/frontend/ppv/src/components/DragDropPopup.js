...
// app component
function DragDropPopup() {
  return (
    <div className="dd"><h1>Connect to Metamask</h1>
    <div className="page">
      <DragDropFile />
      </div>
     </div>
